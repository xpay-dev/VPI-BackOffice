...
{
    [Table("TransactionAttemptCash")]
    public class TransactionAttemptCash
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int TransactionAttemptCashId { get; set; }

        public int TransactionTypeId { get; set; }

        public int TransactionCashId { get; set; }

        [ForeignKey("TransactionCashId")]
        public virtual TransactionCash TransactionCash { get; set; }
