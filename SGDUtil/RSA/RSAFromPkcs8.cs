...
namespace SDGUtil.RSA
{
    public class RSAFromPkcs8
    {
        ...
        public static string sign(string content, string privateKey, string input_charset)
        {
            ...
            string test = Convert.ToBase64String(signData);
        ...
        /// <returns></returns>
        /// 
        public static string pkcs8Encrypt(string privateKey, string content)
        {
            RSACryptoServiceProvider rsa = new RSACryptoServiceProvider();
            byte[] cipherbytes;

            cipherbytes = rsa.Encrypt(Encoding.GetEncoding("utf-8").GetBytes(content), false);
