...
//Start chart1
function getChart1(date, pt, r, m, b, p) {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { 'date': (month + 1) + "/" + day + "/" + year, 'pt': pt, 'r': r, 'm': m, 'b': b, 'p': p },
...
//Start chart 2
function getChart2(date, pt, r, m, b, p) {
    var date = new Date(date);
...
//Start chart 3
function getChart3(date, pt, r, m, b, p) {
    var date = new Date(date);
...
//Start debit chart 1
function getDebitChart1(date, pt, r, m, b, p) {
...
//Start debit chart 2
function getDebitChart2(date, pt, r, m, b, p) {
    var date = new Date(date);
...
//Start debit chart 3
function getDebitChart3(date, pt, r, m, b, p) {
    var date = new Date(date);
