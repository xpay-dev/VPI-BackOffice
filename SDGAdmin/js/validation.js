$(document).ready(function () {
    ...
    var validate = $("#jvalidate-transaction").validate({
        ignore: [],
        rules: {
            "Amount": {
                required: true,
    ...
    //Create new user for CT Ecom
    var validate = $("#jvalidate-adduser").validate({
        ignore: [],
        rules: {
            "Name": {
                required: true
    ...
    //Merchant Branch Registration validation
    var validate = $("#jvalidate-branch").validate({
        ignore: [],
        rules: {
            "BranchName": {
                required: true,
