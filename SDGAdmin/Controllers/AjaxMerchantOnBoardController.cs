    ...
    public class AjaxMerchantOnBoardController : Controller
    {
        ...
        public ActionResult MerchantOnBoardResponseFilenameList()
        {
            try
            {
                ...
                var results = _merchantOnBoardRepo.GetAllMerchantOnBoardResponse(data.sSearch, data.iDisplayStart, data.iDisplayLength, "MerchantOnBoardResponseId", data.sSortDir_0, out totalRecords);
