     ...
     public class MerchantsController : Controller {
          ...
          public ActionResult Registration(string id) {
               ...
               if (!string.IsNullOrEmpty(id)) {
                    TempData["ResellerId"] = Convert.ToInt32(Utility.Decrypt(id.Contains(" ") == true ? id.Replace(" ", "+") : id));
               }
          ...
          public ActionResult Registration(MerchantModel merchant) {
               try {
                    ...
                    merchant.MerchantEmail = merchant.User.EmailAddress;

                    string isoCode = null;
                    string country = "Philippines";//Convert.ToString(CurrentUser.Country);
                    int rId = 0;
                    if (merchant.ResellerId > 0) {
                         rId = merchant.ResellerId;
                    } else {
                         rId = TempData["ResellerId"] == null ? Convert.ToInt32(Convert.ToString(Request["rId"])) : Convert.ToInt32(TempData["ResellerId"]);
                    }
                    ...
                    if ((country == "Philippines") || country == "Philippine") {
                         ...
                         merchant.StateProvince = "Metro Manila";
                         isoCode = "000";
                    } else {
                         merchant.CountryId = 1;
                    }
                    ...
                    if ((country == "Philippines") || country == "Philippine") {
                         ...
                         merchant.User.StateProvince = "Metro Manila";
                         isoCode = "000";
                    } else {
                         merchant.User.CountryId = 1;
                    }
                    ...
                    try {
                         ModelState["MerchantEmail"].Errors.Clear();
                         ModelState["ResellerId"].Errors.Clear();
                    } catch {
                    ...
                    if (ModelState.IsValid && merchant != null) {
                         ...
                         p.ResellerId = rId;//CurrentUser.ParentId;
                    ...
                    err.Action = "Merchant Registration";
                    err.Method = "Submit";
          ...
          public ActionResult MerchantBulkBoarding() {
               ...
               var actRefNumber = ApplicationLog.UserActivityLog("SDGAdmin", userActivity, "MerchantBulkBoarding", "");
                    ...
                    if (Request != null) {
                         ...
                         try {
                              if (extension.Equals(".xls")) {
                                   ...
                                   ModelState.AddModelError(string.Empty, "Not an Excel File.");
                              }
                              ...
                              ModelState.AddModelError(string.Empty, "Can't Register Merchants. Please check the data in your Excel File.");
          ...
          public ActionResult AssignDevice(string id) {
               try {
                    ...
                    var actRefNumber = ApplicationLog.UserActivityLog("SDGAdmin", userActivity, "AssignDevice", "");
                    ...
                    ErrorLog err = new ErrorLog();
                    err.Action = "ActionResult AssignDevice";
                    err.Method = "View";
                    err.ErrText = ex.Message;
                    err.StackTrace = ex.StackTrace;
                    err.DateCreated = DateTime.Now;
          ...
          public ActionResult UpdateInfo(MerchantModel merchant) {
               ...
               try {
                    ...
                    m.MerchantId = Convert.ToInt32(TempData["MerchantId"]);
                    m.MerchantName = Convert.ToString(TempData["MerchantName"]);//merchant.MerchantName;
                    ...
                    m.NeedUpdateToCT = merchant.NeedAddToCT == false ? true : false;
          ...
          public ActionResult ViewAssignedDevices(string id) {
               ...
               var actRefNumber = ApplicationLog.UserActivityLog("SDGAdmin", userActivity, "ViewAssignedDevices", "");
          ...
          [HttpPost]
          public ActionResult ViewAssignedDevices(MerchantDeviceModel merchantModel) {
               try {
                    action = "assigning device to merchant.";

                    string hdnId = Convert.ToString(Request["hdnCtrl"]);
                    string[] deviceId = hdnId.Split(',');

                    if (!String.IsNullOrEmpty(hdnId)) {
                         DeviceMerchantLink merchDevice = new DeviceMerchantLink();

                         foreach (string id in deviceId) {
                              merchDevice.MerchantId = merchantModel.MerchantId;
                              merchDevice.DeviceId = Convert.ToInt32(id);

                              merchDevice = _merchantRepo.RemoveDeviceMerchantLink(merchDevice);
                         }

                         if (merchDevice.DeviceId > 0) {
                              var userActivity = "Assigned a Device to Merchant";
                    ...
                    var errRefNumber = ApplicationLog.LogError("SDGAdmin", errorOnAction + "\n" + ex.Message, "ViewAssignedDevices", ex.StackTrace);
               }
               return View();
          }
          ...
          #region Request Merchant Module
          [HttpPost]
          ...
          public ActionResult RegisterMerchantBranchAndMID(BranchMIDModel bm) {
               try {
                    ...
                    //if (!_userRepo.IsPinAvailable(bm.User.PIN))
                    //{
                    //    ModelState.AddModelError(string.Empty, "PIN is not available.");
                    //}
