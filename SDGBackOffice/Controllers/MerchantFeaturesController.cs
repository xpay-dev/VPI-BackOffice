...
namespace SDGBackOffice.Controllers
{
    ...
    public class MerchantFeaturesController : Controller
    {
        ...
        public ActionResult Agreements(string id)
        {
            ...
            var m = _merchantRepository.GetDetailsbyMerchantId(Convert.ToInt32(Utility.Decrypt(id.Contains(" ") == true ? id.Replace(" ", "+") : id)));
            int mId = 0;
            try
            {
        ...
        public ActionResult AgreementsText(string id)
        {
            ...
            try
            {
                ...
                var a = _merchantfeatureRepository.GetDetailsByAgreementId(Convert.ToInt32(Utility.Decrypt(id.Contains(" ") == true ? id.Replace(" ", "+") : id)));
        ...
        public ActionResult AgreementsText(AgreementsModel agreements, int? id)
        {
            try
            {
                ...
                id = Convert.ToInt32(TempData["MerchantId"]);
                bool isExist = false;
