    ...
    var formElements = function () {
        ...
        var feValidation = function () {
            if ($("form[id^='validate']").length > 0) {
                ...
                ///Uncomment if something wrong happened in some validation part
    ...
    var uiElements = function () {
        ...
        var uiSmartWizard = function () {
            ...
            if ($(".wizard").length > 0) {
                ...
                // This part of code used for Merchant Branch Registration
                if ($("#wizard-validation").length > 0) {
                    // Validation Reference: Insert fields to validate here.
                    var validator = $("#wizard-validation").validate({
                        rules: {
                            ...
                            "InitialUserPricePoint.PricePointEnd": {
                                required: true
                            },
                            "InitialUserPricePoint.Price": {
                                required: true
                            },
                            "InitialMobileAppPricePoint.PricePointEnd": {
                                required: true
                            },
                            "InitialMobileAppPricePoint.Price": {
                                required: true
                            },
                            "EmailReceiptsPrice": {
                                required: true
                            },
                            "PrinterReceiptsPrice": {
                                required: true
                            },
                            "GiftReceiptsPrice": {
                                required: true
