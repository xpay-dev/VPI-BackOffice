...
public class Captcha : IHttpHandler, IReadOnlySessionState
{
    ...
    {
        string strReturn;
        Random oRandoms = new Random();
        int iNumber = oRandoms.Next(100000, 999999);
        ...
        string sCaptchaText = strReturn;//context.Session["Captcha"].ToString();
        context.Session["Captcha"] = strReturn;
        //string sCaptchaText = context.Request["Captcha"].ToString();
        //string sCaptchaText = HttpContext.Current.Session["Captcha"].ToString();
        ...
        string base64 = Convert.ToBase64String(oBytes);
        oOutputBitmap.Dispose();
        oMemoryStream.Close();

        context.Response.Write(base64 + strReturn);
