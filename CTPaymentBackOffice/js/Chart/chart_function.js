...
function getChart1(date, r, m, b, p) {
    ...
    $.ajax({
        url: '/Ajax/GetDailyTransactionCount',
        type: 'POST',
        ...
        success: function (data) {
            ...
            var lineChartData = {
                labels: [day + "-" + monthNames[month], day + 1 + "-" + monthNames[month], day + 2 + "-" + monthNames[month], day + 3 + "-" + monthNames[month], day + 4 + "-" + monthNames[month], day + 5 + "-" + monthNames[month], day + 6 + "-" + monthNames[month]],
                datasets: [
                    {
                        label: "Data set 1",
...
function getChart2(date, r, m, b, p) {
    ...
    $.ajax({
        url: '/Ajax/GetDailySalesTransaction',
        type: 'POST',
        data: { 'date': (month + 1) + "/" + day + "/" + year, 'r': r, 'm': m, 'b': b, 'p': p },
        success: function (data) {
...
function getChart3(date, r, m, b, p) {
    ...
    $.ajax({
        url: '/Ajax/GetDailyDeclinedTransactionCount',
        type: 'POST',
        data: { 'date': (month + 1) + "/" + day + "/" + year, 'r': r, 'm': m, 'b': b, 'p': p },
        success: function (data) {
            var cnt = [];
