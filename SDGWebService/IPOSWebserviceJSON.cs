...
namespace SDGWebService {
     ...
     public interface IPOSWebserviceJSON {
          ...
          [OperationContract]
          [WebInvoke(UriTemplate = "LoginPIN", Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
          POSWSResponse LoginByMobilePin(LoginRequest request);
          ...
          [OperationContract]
          [WebInvoke(UriTemplate = "TransactionPurchaseCreditEMV", Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
          PurchaseResponse TransactionPurchaseCreditEMV(TransactionRequest request); // TransPurchase_Credit_Swipe

          [OperationContract]
          [WebInvoke(UriTemplate = "ForgotMobilePin", Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
          POSWSResponse ForgotMobilePin(POSWSRequest POSWSRequest, string UserEmail, int AccountId);

          [OperationContract]
          [WebInvoke(UriTemplate = "TransactionVoidReason", Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
          TransactionVoidReasonResponse TransactionVoidReason(POSWSRequest request);

          [OperationContract]
          [WebInvoke(UriTemplate = "TransSignatureCapture", Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
