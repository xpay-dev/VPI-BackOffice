...
namespace GatewayProcessor.VeritasPayment
{
    public class SocketClient
    {
        public SwitchResponse CallSynchronousSocketClient(string inputRequest)
        {
            ...
            string ip = ConfigurationManager.AppSettings["PATHVERITASPAY"].ToString();
            int port = Convert.ToInt32(ConfigurationManager.AppSettings["PORTVERITASPAY"]);
